...
import (
	...
	cs "github.com/consensys/gnark/internal/backend/bn254/cs_generic"
...
func TestSerialization(t *testing.T) {
	...
	for name := range circuits.Circuits {
		t.Run(name, func(t *testing.T) {
			...
			r1cs1, err := r1cs.Compile[fr.Element](tc.Circuit)
			if err != nil {
				t.Fatal(err)
			}
			...
			r1cs2, err := r1cs.Compile[fr.Element](tc.Circuit)
			if err != nil {
				t.Fatal(err)
			}

			{
				...
				var reconstructed cs.R1CS[fr.Element, *fr.Element]
			...
			// ensure determinism in compilation / serialization / reconstruction
			{
				...
				var r, r2 cs.R1CS[fr.Element, *fr.Element]
...
func BenchmarkSolve(b *testing.B) {
	...
	var c circuit
	ccs, err := r1cs.Compile[fr.Element](&c)
	if err != nil {
		b.Fatal(err)
	}
